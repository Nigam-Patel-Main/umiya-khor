			...
			<div class="card-body">
				<form method="post" action="/purchase/add" id="purchaseAddForm">
					...
					<button type="submit" class="btn btn-primary btn-sm px-5"
						id="purchaseAddFormSubmitButton">Submit</button>
				</form>
			</div>
		</div>
	</div>
			...
			<div class="card-body">
				...
				<div class="table-responsive">
					<table class="table table-bordered" id="purchaseTable">
						...
						<tbody>
							<c:forEach var="purchasesOrder" items="${purchasesOrders}">
								<tr>
									<td>${purchasesOrder.id}</td>
									<td>${purchasesOrder.shopVo.name}</td>
									<td><fmt:formatDate pattern="dd-MM-yyyy"
											value="${purchasesOrder.purchaseDate}" /></td>
									<td>${purchasesOrder.productAmount}</td>
									<td>${purchasesOrder.expenseAmount}</td>
									<td>${purchasesOrder.totalAmount}</td>
									<td><fmt:formatDate pattern="dd-MM-yyyy h:m a"
											value="${purchasesOrder.createdDate}" /></td>
									<td>
										<div class="dropdown">
											<!--Trigger-->
											...
											<div class="dropdown-menu dropdown-primary">
												<a class="dropdown-item" href="javascript:void(0)"
													onclick="onView(${purchasesOrder.id})"> <em
													class="fas fa-eye "></em>&nbsp;&nbsp;View
												</a> <a class="dropdown-item"
													href="/purchase/update/${purchasesOrder.id}"> <em
													class="fas fa-edit"></em>&nbsp;&nbsp;Update
												</a> <a class="dropdown-item deleteLink"
													href="/purchase/delete/${purchasesOrder.id}"> <em
...
<div class="modal" tabindex="-1" role="dialog" id="purchaseOrderModal">
